    ...
    <>
      ...
      >
        <motion.div
          ...
          transition={{
            duration: 0.8,
            scale: { type: "spring", visualDuration: 0.8, bounce: 0.5, ease: "easeInOut" },
          }}
        >


          <div className="bg-white rounded-2xl mx-2 shadow-2xl p-10 w-full max-w-md transform hover:scale-105 transition-transform duration-300">
