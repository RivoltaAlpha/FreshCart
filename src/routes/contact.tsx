                ...
                <div className="bg-card rounded-3xl shadow-xl p-8">
                  ...
                  <div className="space-y-4">
                    <div className="border-b border-gray-200 pb-4">
                      ...
                      <p className="text-sm">We currently deliver within Nairobi and selected areas in Central Kenya. Check our app for specific coverage in your area.</p>
                    </div>
                    <div className="border-b border-gray-200 pb-4">
                      <h4 className="font-semibold mb-2">How fast is delivery?</h4>
                      <p className="text-sm">Most orders are delivered within 30 minutes to 2 hours, depending on your location and order size.</p>
                    </div>
                    <div className="border-b border-gray-200 pb-4">
                      <h4 className="font-semibold mb-2">What payment methods do you accept?</h4>
                      <p className="text-sm">We accept M-Pesa, credit/debit cards, and cash on delivery for your convenience.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold mb-2">Do you offer refunds?</h4>
                      <p className="text-sm">Yes, we offer full refunds for damaged or unsatisfactory products. Contact us within 24 hours of delivery.</p>
                    </div>
                  </div>
                </div>
              </div>
