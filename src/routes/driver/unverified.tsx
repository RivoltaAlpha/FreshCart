...
export const Route = createFileRoute('/driver/unverified')({
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md border border-gray-100 text-center">
        ...
        <p className="text-gray-600 mb-6">
          You will be able to operate and start delivering once your account is verified. We appreciate your patience!
        </p>
