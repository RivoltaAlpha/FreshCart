    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen bg-background py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold mb-6">About FreshCart</h1>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-fresh-secondary mb-2">50K+</div>
                    <div className="text-fresh-secondary">Happy Customers</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-fresh-secondary mb-2">200+</div>
                ...
                <div className="bg-gradient-to-br from-[#005A61] to-[#00A7B3] rounded-2xl p-8 text-white">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      <Heart className="h-6 w-6 text-fresh-secondary mt-1 flex-shrink-0" />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <Shield className="h-6 w-6 text-fresh-secondary mt-1 flex-shrink-0" />
                      <div>
                    ...
                    <div className="flex items-start gap-3">
                      <Truck className="h-6 w-6 text-fresh-secondary mt-1 flex-shrink-0" />
                      <div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-fresh-secondary mb-2">Lightning Fast Delivery</h3>
                  <p className="">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-fresh-secondary mb-2">Quality Guarantee</h3>
                  <p className="">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-fresh-secondary mb-2">100% Secure Payment</h3>
                  <p className="">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-fresh-secondary mb-2">Customer Support 24/7</h3>
                  <p className="">
